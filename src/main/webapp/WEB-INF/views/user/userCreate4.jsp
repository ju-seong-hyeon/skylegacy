...
<script>
window.Kakao.init("351f262f944235cbd727af404ba92c66");
		...
		success: function(authObj){
			...
			window.Kakao.API.request({
				...
				success: function(res) {
					...
					$('#form-kakao-login input[name=profile_nickname]').val(kakao_account.profile.nickname);
		...
		<div class="login-html">
			...
			<div class="login-form">
				<div class="sign-in-htm">
					...
					<div>
						<a href = "javascript:kakaoLogin();"><img class="kakaoLogin" src="https://www.gb.go.kr/Main/Images/ko/member/certi_kakao_login.png"/></a>
					</div>

					<form id="form-kakao-login" method="post" action="/login/kakaoLogin.do">
		    			<input type="hidden" name="profile_nickname"/>
		    		</form>
